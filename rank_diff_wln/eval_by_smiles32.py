...
def test_stage3():
    predfile = open('/hpc2hdd/home/zshao199/Desktop/code/SPNPS/SPNPS_Platform/backend/data/eval_result/LC_580_118_pred_result_right.txt', 'w')

    parser = OptionParser()
    parser.add_option("-t", "--pred", dest="pred_path", default='/hpc2hdd/home/zshao199/Desktop/code/SPNPS/SPNPS_Platform/backend/data/rank_result/LC_580_118.cbond_detailed_right') # file containing predicted edits
    parser.add_option("-g", "--gold", dest="gold_path", default='/hpc2hdd/home/zshao199/Desktop/code/SPNPS/SPNPS_Platform/backend/data/tjn/LC-prediction_selected.txt.proc') # file containing true edits
    ...
    try:
        rank = []
        n,top1,top2,top3,top5,top31,gfound = 0,0,0,0,0,0,0
        top1_sani, top2_sani, top3_sani, top5_sani,top31_sani, gfound_sani = 0, 0, 0, 0, 0,0
        for line in fpred:
            thisrow = []
            line = line.strip('\r\n |')
            gold = fgold.readline()
            ...
            if n >= 10:
                print('[strict]  acc@1: %.4f, acc@2: %.4f, acc@3: %.4f, acc@5: %.4f, acc@31: %.4f (after seeing %d), gfound = %.4f' % (top1 / n, top2 / n, top3 / n, top5 / n, top31 / n, n, gfound / n))
                #print('[strict]  acc@1: %.4f, acc@2: %.4f, acc@3: %.4f, acc@5: %.4f (after seeing %d),acc@31: %.4f  , gfound = %.4f' % (top1 / n, top2 / n, top3 / n, top5 / n, top31 / n, n, gfound / n))

...
def test_stage2():
    predfile = open('XX.cbond_detailed_right', 'w')
    parser = OptionParser()
    parser.add_option("-t", "--test", dest="test_path", default="XX.txt.proc")
    parser.add_option("-p", "--cand", dest="cand_path", default="YY.cbond")
    parser.add_option("-a", "--ncand", dest="cand_size", default=500)
    parser.add_option("-c", "--ncore", dest="core_size", default=16)
    parser.add_option("-m", "--model", dest="model_path", default="/ZZ")
    parser.add_option("-w", "--hidden", dest="hidden_size", default=500)
    parser.add_option("-d", "--depth", dest="depth", default=3)
    parser.add_option("--checkpoint", dest="checkpoint", default="ckpt-XX")
    ...
    q = tf.queue.FIFOQueue(100, [tf.float32, tf.float32, tf.int32, tf.int32, tf.int32, tf.float32])

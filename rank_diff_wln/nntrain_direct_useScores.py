...
parser = OptionParser()
parser.add_option("-t", "--train", dest="train_path",default="../data/XX.txt.proc")
parser.add_option("-p", "--cand", dest="cand_path", default="../data/YY.cbond")
parser.add_option("-b", "--batch", dest="batch_size", default=16)
parser.add_option("-a", "--ncand", dest="cand_size", default=150)
parser.add_option("-c", "--ncore", dest="core_size", default=40)
...
parser.add_option("-l", "--model", dest="model_path", default="/NN")
parser.add_option("--checkpoint", dest="checkpoint", default="13800")
...
_input_atom = tf.compat.v1.placeholder(tf.float32, [None, None, adim])
_input_bond = tf.compat.v1.placeholder(tf.float32, [None, None, bdim])
_atom_graph = tf.compat.v1.placeholder(tf.int32, [None, None, max_nb, 2])
_bond_graph = tf.compat.v1.placeholder(tf.int32, [None, None, max_nb, 2])
_num_nbs = tf.compat.v1.placeholder(tf.int32, [None, None])
_core_bias = tf.compat.v1.placeholder(tf.float32, [None])
...
q = tf.queue.FIFOQueue(100, [tf.float32, tf.float32, tf.int32, tf.int32, tf.int32, tf.float32, tf.int32])
...
param_norm = tf.linalg.global_norm(tvs)
